= rehash=1
:description: Data is restored to an operating system that is different from the backup operating system using the cbrestore tool with the rehash=1 option

= couchbase-cli-change-ip-family(1)
ifndef::doctype-manpage[:doctitle: cluster-edit]

ifdef::doctype-manpage[]
== NAME

couchbase-cli-change-ip-family -
endif::[]
...
[verse]
_couchbase-cli change-ip-family_ [--cluster <url>] [-username <username>]
...
can change the IP family being used to IPv6 by using the following command.
  ...
  $ couchbase-cli change-ip-family -c http://cb1.com:8091 -u Administrator \
    -p password --set --ipv6

...
gen_docs couchbase-cli-backup-service-repository.adoc 1
gen_docs couchbase-cli-backup-service-plan.adoc 1
...
gen_docs couchbase-cli-analytics-link-setup.adoc 1

...
CMD_UPR_NOOP = 0x5C
CMD_UPR_BUFFER_ACK = 0x5D
CMD_UPR_CONTROL = 0x5E
...
#UPR control keys
KEY_UPR_CONNECTION_BUFFER_SIZE = "connection_buffer_size"
KEY_UPR_STREAM_BUFFER_SIZE = "stream_buffer_size"
